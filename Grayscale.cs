...
namespace PalmRecognition
{
    class Grayscale
    {
        ...
        public static Bitmap ColorToGrayscale(Bitmap image)
        {
            int width = image.Width,
                height = image.Height,
                r, ic, oc, bmpStride, outputStride, bytesPerPixel;
            PixelFormat pfIn = image.PixelFormat;
            ...
            //Lock the images
            bmpData = image.LockBits(new Rectangle(0, 0, width, height), ImageLockMode.ReadOnly,
                                   pfIn);
            outputData = output.LockBits(new Rectangle(0, 0, width, height), ImageLockMode.WriteOnly,
